...
// DatePicker component, adjusted for Dutch internationalization
...
(function($) {
  ...
  class Datepicker extends Component {
    ...
    _renderDateDisplay() {
      ...
      this.dateTextEl.innerHTML = `${day} {$date} ${month}`;        // NL
    }
    ...
    adjustCalendar(calendar) {
      if (calendar.month < 0) {
        ...
        if (calendar.year < this.options.yearRange[0]) {
          calendar.year = this.options.yearRange[0];
        }
        calendar.month += 12;
      }
      if (calendar.month > 11) {
        ...
        if (calendar.year > this.options.yearRange[1]) {
          calendar.year = this.options.yearRange[1];
        }
        calendar.month -= 12;
      }
      return calendar;
